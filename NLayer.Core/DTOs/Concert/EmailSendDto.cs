...
namespace NLayer.Core.DTOs.Concert
{
    public class EmailSendDto
    {
        ...
        [MinLength(3, ErrorMessage = "{0} alanı en az {1} karakterden oluşmalıdır.")]
        ...
        [DisplayName("Konu")]
        [Required(ErrorMessage = "{0} alanı zorunludur.")]
        [MaxLength(150, ErrorMessage = "{0} alanı en fazla {1} karakterden oluşmalıdır.")]
        ...
        [MinLength(15, ErrorMessage = "{0} alanı en az {1} karakterden oluşmalıdır.")]
