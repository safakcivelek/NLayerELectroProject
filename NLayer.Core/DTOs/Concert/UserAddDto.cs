...
namespace NLayer.Core.DTOs.Concert
{
    public class UserAddDto
    {
        ...
        public IFormFile PictureFile { get; set; } // IFormFile tipinde resmin kendisini(dosyasını) tutuyor.
        public string Picture { get; set; } // Resimlerin string olarak adını tutuyor.whic
        [DisplayName("Adı")]
        [MaxLength(30, ErrorMessage = "{0} {1} karakterden büyük olmamalıdır.")]
